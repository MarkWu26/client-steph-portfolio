...
const Footer = () => {
  return (
    <div className="bg-[#04091E] text-white h-[40vh] py-12 px-40 items-center">
      <div className="flex flex-row mt-6">
        <div className="flex flex-col w-[50%] gap-x-12">
          <div className="text-[24px] font-bold mb-6">About Me</div>
        ...
        <div className="flex flex-col pl-24">
          <div className="text-[24px] font-bold mb-6">Follow me!</div>
          <div className="mb-3 text-gray-300">
            ...
            <div>
            <span className="py-2 text-[14px] mb-3 text-gray-300">SMorenoContreras@gmail.com</span>
            </div>
